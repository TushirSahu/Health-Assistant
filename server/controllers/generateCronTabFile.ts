...
export const generateCronTabFile = (req: Request, res: Response) => {
    ...
    const schema = z.object({
        ...
        dates: z.array(z.number().min(0, {message: "Dates should be greater than 0"}).max(31, {message: "Days should be less than 31"})),
        medicine: z.string(),
    }).array();
    ...
    res.setHeader('Content-Disposition', 'attachment; filename=cronTabFile.txt');
